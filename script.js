...
function toggleFullscreen() {
    ...
    if (!document.fullscreenElement) {
        document.documentElement.requestFullscreen().catch(err => {
            console.log(`No se pudo poner en pantalla completa: ${err.message}`);
        });
    } else {
...
// [NUEVO] Recalcula la cámara si la pantalla cambia de tamaño (rotar móvil o redimensionar ventana en PC)
