...
function openNPCModal() {
    ...
    document.getElementById('npcIcon').innerHTML = `<img src="${npc.img}" style="width: 256px; height: 256px; image-rendering: pixelated; border-radius: 8px; border: 2px solid var(--accent); background: #0b1220;">`;
...
window.addEventListener('keydown', e => {
    ...
    // [NUEVO] Tecla ESCAPE para abrir/cerrar menú principal
...
function setupTouchControls() {
    const bindTouch = (id, dx, dy) => {
        ...
        btn.addEventListener('touchstart', (e) => {
            e.preventDefault(); // Evita doble-click, zoom in/out accidental y scroll de la pantalla
            move(dx, dy);
        }, { passive: false });
        
        // También enlazamos mousedown para depuración o si el usuario usa mouse en PC
