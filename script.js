...
function centerCamera() {
    ...
    // TAMAÑO FIJO Y SEGURO DE 128px (Asegura compatibilidad móvil sin deforma el CSS)
    const tileSize = 130; // 128px + 2px gap
...
/* =========================================
   EVENTOS DE TECLADO Y REDIMENSIONADO
   ========================================= */
...
// FUNCIÓN TÁCTIL PARA D-PAD (Para llamar desde el HTML)
